...
describe("Views", () => {
  it.only("Orders ", () => {
    ...
    it.only("Purchase Order Lines - Basic", () => {
      ...
      cy.get('[title*=".tabs.basic"]')
        .eq(1)
        .contains("Basic")
        .click({ force: true });

      cy.get('[data-act-table-target="column"][data-column="#"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ).should("be.visible");
      cy.get(
      ...
      cy.get('[data-act-table-target="column"][data-column="quantity"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="ordered_sn"]'
      ).should("be.visible");
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="allocated"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="picking"]').should(
        "be.visible"
      );
      ...
      cy.get('[data-act-table-target="column"][data-column="shipped"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="hold"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="cancelled"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="origin_location"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="inventory"]'
      ).should("be.visible");
    }),
    it.only("Purchase Orders Lines - Items", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="sn"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="lot"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="origin_location"]'
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="bin_location"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="container"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="tote"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="parcel"]').should(
        "be.visible"
      );
    }),
    it.only("Purchase Orders Lines - Pricing and values", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="position"]')
        ...
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="description"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customs_description"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customs_currency"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customs_value"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customs_value_amount"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="declared_insurance_currency"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="declared_insurance_value"]'
      ).should("be.visible");
    }),
    it.only("Transfer Order Lines - Basic", () => {
    ...
    it.only("Transfer Orders Lines - Items", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="tote"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="parcel"]').should(
        "be.visible"
    ...
    it.only("Transfer Orders Lines - Pricing and values", () => {
      // Purchase Orders Lines - Pricing and values
      cy.visit("/orders?type=Orders%3A%3ATransferOrder");
      cy.url().should("include", "/orders?type=Orders%3A%3ATransferOrder");
      cy.get(
    ...
    it.only("Sales Orders Lines - Items", () => {
    ...
    it.only("Sales Orders Lines - Pricing and values", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="currency"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="price"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="quantity"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="amount"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="discount"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="tax"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="line_total"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customs_description"]'
      )
    ...
    it.only("Return Order Lines - Basic", () => {
    ...
    it.only("Return Orders Lines - Items", () => {
    ...
    it.only("Scrap Order Lines - Basic", () => {
    ...
    it.only("Scrap Orders Lines - Items", () => {
      // Return Orders Lines - Items
      cy.visit("/orders?type=Orders%3A%3AScrapOrder");
      cy.url().should("include", "/orders?type=Orders%3A%3AScrapOrder");
cy.get('[data-action="click->satis-menu#show mouseleave->satis-menu#hide"]')
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    it.only("Scrap Orders Lines - Pricing and values", () => {
      ...
      cy.visit("/orders?type=Orders%3A%3AScrapOrder");
        ...
        cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(
          ($e1) => {
            const text = $e1.text();
            if (text.includes("Reset view")) {
              cy.contains("Reset view").click();
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="name"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="orders"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="channels"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="shipping_methods"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customer_references"]'
      )
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="wave"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="pick_list_plan"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="picker"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="quantity_to_pick"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="quantity"]').should(
        "be.visible"
      );
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="pick_list_type"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="# applicable orders"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="# waves"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="# pick lists"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="pick_lists"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="carrier"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="service_type"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="parcels"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="orders"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="customer_reference_numbers"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="tracking_number"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="return_tracking_number"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="product_account"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="location"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="bin_location_purpose"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ).should("be.visible");
      ...
      cy.get('[data-act-table-target="column"][data-column="expired"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="total"]').should(
        "be.visible"
      );
    }),
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="bin_locations"]'
      ).should("be.visible");
    }),
    it.only("License plates ", () => {
      // License plates
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="license_plate"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="location"]').should(
        "be.visible"
      );
      ...
      cy.get('[data-act-table-target="column"][data-column="state"]')
        ...
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="serial_number"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="lot"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="expires_on"]'
      ).should("be.visible");
    }),
    it.only("Containers ", () => {
      // Containers
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="open_or_closed"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="number"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="name"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="ean_or_upc"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="category"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="kit"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="lot_tracked"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="lot_pattern"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="serialized"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="serialization_mode"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="serial_number_pattern"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="expirable"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="weight"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="origin_country_code"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="standard_bin_location"]'
      )
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="actions"]').should(
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="contact"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="company"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="email"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="phone"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="city"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="State/Province"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="country"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    it.only("Reporting - Bin location movements ", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="transacted_at"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="user"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="order"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="account_name"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ).should("be.visible");
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="from_location_name"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="from_bin_location_name"]'
      )
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        ...
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="to_location_name"]'
      ).should("be.visible");
      cy.get(
    ...
    it.only("Reporting - Container Bin Location Movements ", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="container_name"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="from_location_name"]'
      ).should("be.visible");
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="from_bin_location_purpose"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="to_location_name"]'
      ).should("be.visible");
    ...
    it.only("Reporting - Container Inventory Adjustments ", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="inventory_adjust"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="total_inventory_count"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="transacted_at"]'
      ).should("be.visible");
    }),
    it.only("Reporting - Inbounded inventory items", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="received_by"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="order"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="order_type"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="customer_reference_number"]'
      ).should("be.visible");
      ...
      cy.get('[data-act-table-target="column"][data-column="delivery_terms"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="vendor"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="shipping_container"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="shipping_container_number"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_description"]'
      ).should("be.visible");
      cy.get(
      ...
      cy.get('[data-act-table-target="column"][data-column="bin_location"]')
        ...
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_category"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="un_number"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="status"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="packing_material_number"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="packing_material_name"]'
      ).should("be.visible");
      cy.get(
    ...
    it.only("Reporting - Inventory on hand", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="outer_container"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="inner_container"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="location"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="inbounded_at"]'
      ).should("be.visible");
    }),
    it.skip("Reporting - Manual inventory adjustments", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="location"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="bin_location"]'
      ...
      cy.get('[data-act-table-target="column"][data-column="comments"]').should(
        "be.visible"
      );
    }),
    it.only("Reporting - Open sales orders", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="address"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="city"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="postal_code"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="country"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="allocated_at"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="ship_at"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="country_of_origin"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="currency"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="value"]').should(
        "be.visible"
      );
    }),
    it.only("Reporting - Open receives", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="inbound_tracking_number"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="forwarder"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="shipping_container"]'
      ).should("be.visible");
      ...
      cy.get('[data-act-table-target="column"][data-column="vendor_name"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="quantity_ordered"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="quantity_received"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="last_received_at"]'
      ).should("be.visible");
    }),
    it.only("Reporting - Replenishment items", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="picking_available"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="reorder_level"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="reorder_quantity"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="receiving_available"]'
      )
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="replenishment_available"]'
      )
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="replenishment_needed_for_orders_today"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="replenishment_needed_for_orders"]'
      ).should("be.visible");
    }),
    it.only("Reporting - Shipped products", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="shipped_at"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="shipment"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ...
      cy.get('[data-act-table-target="column"][data-column="delivery_terms"]')
        ...
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="shipping_method"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="ship_at"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="ship_earliest_on"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="company_name"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="contact"]').should(
        "be.visible"
      );
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="tracking_number"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="carrier"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="from_location"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="product_number"]'
      ).should("be.visible");
      ...
      cy.get('[data-act-table-target="column"][data-column="packaging_number"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="weight"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="weight_unit"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="length"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="width"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="height"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="dimension_unit"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="serial"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="lot"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="product_category"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="un_number"]'
    ...
    it.only("Reporting - Shipped serial numbers", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="destination_contact"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="destination_country"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="carrier"]').should(
        "be.visible"
      );
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="priority"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="subject"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="group"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="assignee"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="requester"]'
      ).should("be.visible");
      cy.get(
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="organization"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    it("Tickets - Contacts", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="twitter"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="time_zone"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="group"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="organization"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="owner"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="suspended"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="url"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="domains"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
    ...
    it.only("Billing - Events", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="event_type"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="fields"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="quantity"]').should(
        "be.visible"
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="transaction"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="user"]').should(
        "be.visible"
      );
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="code"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="name"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="parent_account"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
    ...
    it("Users", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="first_name"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="last_name"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="company"]').should(
        "be.visible"
      );
      ...
      cy.get('[data-act-table-target="column"][data-column="roles"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="time_zone"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="countries"]'
      ).should("be.visible");
    }),
    it.only("Channels", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    it("Shipping methods", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="default_packing_material"]'
      ).should("be.visible");
    }),
    it.skip("Holidays", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="start_on"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="end_on"]').should(
        "be.visible"
      );
    }),
    it.only("Reasons", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="address_lines"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="postal_code"]'
      ).should("be.visible");
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="purpose"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="zone"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="walkway"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="aisle"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="rack"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="shelf"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="section"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="bin"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="inventory"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="standard_for_product"]'
      ).should("be.visible");
    }),
    it.only("Totes", () => {
...
cy.get('[data-satis-menu-submenu-placement="bottom"] li').then(($e1) => {
  ...
  if (text.includes("Reset view")) {
    ...
    cy.contains('[title*="index.orders"]', "Orders").click();
      ...
      cy.get('[data-act-table-target="column"][data-column="level"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="number"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="physical_packaging"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="physical_qualifier"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="pickable"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="created_at"]')
        .scrollIntoView()
    ...
    it("Data protection and privacy: Order anonymize period", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/003da152-ac02-4f35-aca9-1244e5fb7d10"
      );
    }),
    it("Data protection and privacy: Shipment anonymize period", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/987e87c8-f004-415a-b1cf-c7c24e81fe96"
      );
    }),
    it("i18n: Working days", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/a6def0ad-37ff-4c26-8cab-2c2348576232"
      );
    }),
    it("Internationalization: Default currency", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/3e4e5efc-f4fa-4635-9831-adcaa15c9bd1"
      );
    }),
    it("Internationalization: Week start", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/1d299c7e-8b7e-4773-930b-cd6d832a343b"
      );
    }),
    it("Internationalization: Working days", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/6fef5d8b-aa85-40a7-a028-5f736ad2b8b2"
      );
    }),
    it("Inventory: Allow kit to inventory", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/5b341bc6-185a-4a03-a0fb-a0e97cb9330a"
      );
    }),
    it("Inventory: Container required", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/7fa11f93-5195-4828-b27b-808dab698a3d"
      );
    }),
    it("Inventory: Ignore container levels", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/67df40f4-4827-4ca9-adb8-ee6fe2bfdefc"
      );
    }),
    it("Inventory: Multiple products per container", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/722389f0-2500-424e-bb82-46fd2b981022"
      );
    }),
    it("Inventory: Recycle serial numbers", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/a33536c2-1d92-4528-bfd7-6529e53aa6da"
      );
    }),
    it("Inventory: Reorder quantity", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/0e68e0c8-d328-43ab-a860-5fb7dd6da7a0"
      );
    }),
    it("Inventory: Reporting percent", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/fb4c4826-b930-48aa-84d5-62bfc3691871"
      );
    }),
    it("Inventory: Restrict transactions to setup complete", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/cf3d8cce-166e-43c5-a6a6-1c7d5220a714"
      );
    }),
    it("Inventory: Target stock level", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/9fd4a450-3478-4408-b07a-9526e2ac1aa0"
      );
    }),
    it("Modules: Async picking", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/78bd91e5-a9e5-41a6-b4d5-fc61dc1f2b6a"
      );
    }),
    it("Modules: Shopify", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/113c7044-240e-461f-85a4-0ca577284c49"
      );
    }),
    it("Packing: Add to open shipment", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/d0c85323-63aa-4856-9817-5bff1e4dbe61"
      );
    }),
    it("Packing: Auto ship", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/1eff10f6-070b-41b8-9a7d-b4994b2981a0"
      );
    }),
    it("Packing: Consume product packing materials", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/358318de-2843-4e5b-b81a-79f59cf7719e"
      );
    }),
    it("Packing: Default packing material", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/46bb6bb8-120a-414d-bb4c-f33f61428aca"
      );
    }),
    it("Packing: Select product packing materials", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/edc8145f-660e-465d-b428-89f3526aeffc"
      );
    }),
    it("Picking: Auto pack", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/15207ed5-8368-40eb-a680-5fbb5849ed4a"
      );
    }),
    it("Picking: Auto retire containers", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/e86415d3-73dd-4b27-9942-2101e69a89ed"
      );
    }),
    it("Bulk strategy", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/2e0c43a4-ec0d-4c8a-95bf-a8e6b95121ea"
      );
    }),
    it("Picking: Display product description", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/eb40444c-7c95-4613-9875-a1e9a4232f90"
      );
    }),
    it("Picking: Pending picking allowed", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/9dbe3c40-1510-4190-b84c-30efbb120327"
      );
    }),
    it("Purging: Completed orders", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/c84f8a88-7ca3-43ca-a3be-5cefbf289c87"
      );
    }),
    it("Purging: Concept orders", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/55435ef6-02fe-4c21-b2e1-66ddf0fd98d7"
      );
    }),
    it("Purging: Importo imports", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/2a5f9ff8-1efb-4d69-8db0-8a66e7ed4471"
      );
    }),
    it("Purging: Nuntius messages", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/8ce00b2b-0b4d-48d0-ba74-09da1d60848c"
      );
    }),
    it("Purging: Retired inventory", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/fb8630c2-78dd-486f-926f-f213e6999107"
      );
    }),
    it("Purging: Vorto messages", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/21531303-c1d8-4ed1-9550-e65060a66717"
      );
    }),
    it("Receiving: Over receive", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/263c703a-36d9-4689-8153-ba861ed9f3b0"
      );
    }),
    it("Receiving: Over receive different product", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/1c538a0b-ca60-40bb-a10c-069521c54497"
      );
    }),
    it("Sales Orders: Required delivery contact fields	", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/1fc04935-7c4e-49d9-8b5f-ba8c4f44cd2a"
      );
    }),
    it("Shipping: Backorder shipping method", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/f0af7fc7-305b-4ea3-9f98-3a41ebad7c94"
      );
    }),
    it("Shipping: Cutoff time", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/70f4bafe-a060-4183-b328-f04d6ce99ca2"
      );
    }),
    it("Shipping: Default business model", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/9f6ee91d-7cfc-4172-baec-0dacf586b2a1"
      );
    }),
    it("Shipping: Default delivery terms", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/9e389941-3a5b-4372-b923-076255ecfb01"
      );
    }),
    it("Shipping: Default shipping method", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/c4a5d331-960f-4b48-84a9-e01d92771455"
      );
    }),
    it("Shipping: Partial shipping", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/39eb1980-be31-4043-8035-f53828b46656"
      );
    }),
    it("Shipping: Shipping method required", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/b4550206-c0b6-4204-aa80-684100277239"
      );
    }),
    it("Shipping: Sla days", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/9571719d-4fa3-4e1a-b4ac-9454386870b5"
      );
    }),
    it("Warehousing: Picking bin location name", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/161f98d2-ab23-4425-81b7-289e9bb14404"
      );
    }),
    it("Warehousing: Problem bin location name", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/e3ba6913-182b-47a3-b7c7-94f4a4616d9a"
      );
    }),
    it("Warehousing: Receiving bin location", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/dac325c2-70d0-42c7-9455-eb4aae78bc47"
      );
    }),
    it("Warehousing: Receiving bin location name", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/46315817-da8d-4152-ac04-c1a2c4c3ebc1"
      );
    }),
    it("Warehousing: Shipping bin location", () => {
      ...
      cy.url().should(
        "include",
        "/settings/settings/12a15265-d981-4a3c-940d-cbc0428fbcbb"
      );
    }),
    it("Integration", () => {
      // Admin - Integration
      ...
      cy.get('[data-act-table-target="column"][data-column="flow"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="extract"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
    ...
    it("Integration - Flows", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="enabled"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="klass"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="event"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="trigger"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="metadata"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
    ...
    it("Integration - Credentials", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="key"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="metadata"]').should(
        "be.visible"
    ...
    it("Integration - Oauth - Authorized", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="scopes"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="created_at"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="#"]').should(
        "be.visible"
      );
    }),
    it("Integration - Oauth - Applications", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="uid"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="redirect_uri"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="scopes"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
    ...
    it("Integration - Third Party", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="integration_account"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="endpoint"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="account"]').should(
        "be.visible"
    ...
    it("Imports", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="kind"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="original"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="result"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="extra_links"]')
        .scrollIntoView()
        .should("be.visible");
    }),
    it.skip("Messaging", () => {
    ...
    it("Messages", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="to"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="last_sent_at"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="origin"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="subject"]').should(
        "be.visible"
    ...
    it("Messaging - Templates", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="messages"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="metadata"]').should(
        "be.visible"
    ...
    it("Messaging Campaigns", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="transport"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="state"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="list"]').should(
        "be.visible"
      );
    }),
    it("Messaging Lists", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="subscribers"]'
      ).should("be.visible");
    }),
    it("Papers", () => {
      // Admin - Papers
      ...
      cy.get('[data-act-table-target="column"][data-column="template"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="attachment"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
    ...
    it("Papers Templates", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="papers_count"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="kind"]').should(
        "be.visible"
      );
    ...
    it("Admin - Apps", () => {
      ...
      cy.get('[data-act-table-target="column"][data-column="icon"]').should(
        "be.visible"
      );
      cy.get('[data-act-table-target="column"][data-column="name"]').should(
        "be.visible"
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="release_type"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="operating_system"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="created_at"]'
      ).should("be.visible");
    ...
    it("Billing Rate groups", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="rate_group"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="description"]'
      ).should("be.visible");
    ...
    it("Billing Rate types", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="charge_code"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="recent_events"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="rate_type"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="rate_period"]')
        .scrollIntoView()
        .should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="rate_count"]'
      ).should("be.visible");
    }),
    it("Billing Rates", () => {
      // Admin - Billing Rates
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="valid_from"]'
      ).should("be.visible");
      cy.get(
        '[data-act-table-target="column"][data-column="valid_until"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="price"]').should(
        "be.visible"
      );
    ...
    it("Exceptions", () => {
      ...
      cy.get(
        '[data-act-table-target="column"][data-column="exception_class"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="message"]').should(
        "be.visible"
      );
      cy.get(
        '[data-act-table-target="column"][data-column="code_location"]'
      ).should("be.visible");
      cy.get('[data-act-table-target="column"][data-column="count"]').should(
        "be.visible"
      );
      cy.get(
