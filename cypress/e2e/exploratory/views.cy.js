...
beforeEach(() => {
  ...
  describe('Views', () => {
    ...
    it('Containers ', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="contents"]').should('be.visible')
    ...
    it('Reporting - Inbounded inventory items', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="total_weight"]').should('be.visible')
    ...
    it('Reporting - Manual inventory adjustments', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="order"]', { timeout: 20000} ).should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="product_number"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="product_name"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="quantity"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="serial_number"]').should('be.visible')
    ...
    it('Tickets', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="organization"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="created_at"]').scrollIntoView().should('be.visible')
    ...
    it('Users', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="company"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="email"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="roles"]').should('be.visible')
    ...
    it('Locations', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="postal_code"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="city"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="state_or_province_code"]').should('be.visible')
    ...
    it('Settings', () => {
        ...
        // Settings
        cy.visit('https://oms.staging.boxture.com/settings/settings?settable=BAh7CEkiCGdpZAY6BkVUSSI7Z2lkOi8vb21zL0FjY291bnQvZTY4YzllMWYtMjExOC00MDVmLTgzNWQtZTM0ODUzMWRlZTc2BjsAVEkiDHB1cnBvc2UGOwBUSSIKVmFyaW8GOwBUSSIPZXhwaXJlc19hdAY7AFRJIh0yMDIzLTA1LTE0VDExOjE1OjQ3LjM5NFoGOwBU--45a4ed9be250d510b978b83ee3e8540a1a12f23c')
    ...
    it('Integration', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="state"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="subject"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="children"]').should('be.visible')
    ...
    it('Integration - Oauth - Applications', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="confidential"]').should('be.visible')
    ...
    it('Papers', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="created_at"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="actions"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="consolidation_id"]').should('be.visible')
    ...
    it('Papers Templates', () => {
        ...
        cy.get('[data-act-table-target="column"][data-column="kind"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="use"]').should('be.visible')
        cy.get('[data-act-table-target="column"][data-column="copies"]').should('be.visible')
