...
beforeEach(() => {
  ...
  describe('Filters Orders overview', () => {
    ...
    it('ID Filter', () => {
      ...
      cy.wait(1000)
      cy.get('[data-column="order_number"]').find('[type="button"]').should('be.visible').click()
      cy.get('[data-column="order_number"]').find('li').should('have.length', '5')
      cy.get('[data-column="order_number"]').find('li').contains('Filter values').should('be.visible')
      cy.get('[data-column="order_number"]').find('li').contains('Sort ascending').should('be.visible')
      cy.get('[data-column="order_number"]').find('li').contains('Sort descending').should('be.visible')
      cy.get('[data-column="order_number"]').find('li').contains('Hide column').should('be.visible')
